        ...
        {scanning ? (
          <div className="relative w-full h-64 mb-4">
            ...
            <button
              ...
              className="absolute top-2 right-2 bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700"
            >
              Arrêter le scan
            </button>
          </div>
          ...
          <button
            type="button"
            onClick={toggleScanning}
            className="mb-4 bg-blue-600 dark:bg-white text-white dark:text-blue-900 py-2 px-4 rounded-md hover:bg-blue-700"
          >
